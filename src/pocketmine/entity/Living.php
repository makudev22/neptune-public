...
abstract class Living extends Entity implements Damageable
{
   ...
   protected float $swingProgress = 0;
        ...
        public function swing(bool $updateSelf) : void {
                // Only allow a new swing if no swing is in progress, or the current
                // swing has progressed past the halfway point. The previous condition
                // "$this->swingProgressInt < 0" allowed double-swings within the same
                // tick (swingProgressInt is set to -1 at the start), causing the arm
                // animation to play twice when breaking/placing blocks.
