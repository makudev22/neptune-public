...
use pocketmine\network\mcpe\convert\constants\itemStackRequestActionTypeIds\ItemStackRequestActionType2193;
...
class ConstantTranslator
{
	...
	public function __construct()
	{
		...
		$this->collect(ItemStackRequestActionType::class, [
			ProtocolInfo::PROTOCOL_2193 => ItemStackRequestActionType2193::class,
