...
final class ItemTranslator
{
	 ...
	 */
	public function __construct(private ItemTypeDictionary $dictionary, array $simpleMappings, array $complexMappings)
	{
	...
	public function toNetworkName(int $internalId, int $internalMeta) : array
	{
		[$networkId, $networkMeta] = $this->toNetworkId($internalId, $internalMeta);
		return [$this->dictionary->fromIntId($networkId), $networkMeta];
	}
