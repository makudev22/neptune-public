...
class RakLibInterface implements ServerEventListener, AdvancedNetworkInterface, PacketSender
{
	...
	public function start() : void
	{
		...
		$this->setPortCheck($this->server->getNeptuneProperty("network.port-checking", true));
		$this->setPacketLimit($this->server->getNeptuneProperty("network.packet-limit", 1000));
	}
