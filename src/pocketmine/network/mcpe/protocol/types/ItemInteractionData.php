...
final class ItemInteractionData
{
	...
	public static function read(NetworkBinaryStream $in) : self
	{
		...
		$requestChangedSlots = [];
		if ($in->getProtocol() >= ProtocolInfo::PROTOCOL_2193 ? $in->getBool() : $requestId !== 0) {
		...
		$transactionData->decode($in, $in->getProtocol() >= ProtocolInfo::PROTOCOL_2193);
	...
	public function write(NetworkBinaryStream $out) : void
	{
		...
		$this->transactionData->encode($out, $out->getProtocol() >= ProtocolInfo::PROTOCOL_2193);
	}
}
