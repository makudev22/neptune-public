	...
	public function execute(CommandSender $sender, string $commandLabel, array $args)
	{
		...
		if (count($args) === 0) {
			...
			$messages = [
				...
				new TranslationContainer('pocketmine.server.info.extended.main', [TextFormat::GREEN . $server->getName(), TextFormat::GREEN . $server->getNeptuneVersion(), TextFormat::GREEN]),
